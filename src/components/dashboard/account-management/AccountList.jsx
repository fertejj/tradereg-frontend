...
const AccountList = ({ onAccountSelected }) => {
  const { accounts, selectedAccount, setSelectedAccount, deleteAccount } = useAccounts();
  ...
  return (
    <div>
      {accounts.map((account) => (
        <div key={account._id} className="flex items-center mb-2">
          <div
